...
1. Check [existing issues](https://github.com/thiagomvas/LogPort/issues) to see if it’s already reported.
...
1. **Create an issue first** describing what you want to do.
2. Discuss and get feedback — this saves wasted effort and ensures your work aligns with project goals.
...
5. Open a pull request (PR) against the `master` branch of the main repo.
